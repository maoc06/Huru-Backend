...
var _validateMaxCarAge = _interopRequireDefault(require("../utils/validate-max-car-age"));
...
function buildMakeCar() {
  return function makeCar({ ...entity
    ...
    if (!(0, _validateMaxCarAge.default)(year)) throw new Error('Car cannot be more than 11 years seniority');

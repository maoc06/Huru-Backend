...
exports.default = makeListCarModelsByMaker;

function makeListCarModelsByMaker({
  carBasicSettingsDb,
  makerDb
}) {
  return async function listCarModelsByMaker({
    makerId
  } = {}) {
    ...
    if (!models) throw new Error(`No models found for maker with id ${makerId}`);
    return models;
  };
}